...
contract StrategyAaveV2 is BaseStrategy {
    ...
    function harvest() public override whenNotPaused {
        ...
        IAaveV3Incentives controller = IAaveV3Incentives(incentivesController);
        address[] memory assets = controller.getRewardsList();
        // claim all rewards to the vault
        controller.claimAllRewards(assets, address(vault));
